...
export const Button = styled.button`
  ...
  background-image: ${(props) =>
    `linear-gradient(to bottom, ${props.theme.bg.secondary}, ${props.theme.bg.primary})`};
  ...
  &:active {
    ...
    background-image: ${(props) =>
      `linear-gradient(to top, ${props.theme.bg.secondary}, ${props.theme.bg.primary})`};
  }
...
export const FacebookButton = styled.button`
  ...
  &:hover {
    color: ${(props) => props.theme.text.onPrimary};
    background-image: ${(props) =>
      `linear-gradient(to bottom, ${tint(props.theme.social.facebook, 16)}, ${tint(props.theme.social.facebook, 16)})`};
    box-shadow: ${(props) =>
      props.disabled ? 'none' : props.theme.shadows.button};
  }
  ...
  &:focus {
    box-shadow:
      0 0 0 1px ${(props) => props.theme.bg.secondary},
      0 0 0 3px ${(props) => hexa(props.theme.social.facebook, 0.16)};
  }
`;
...
export const TwitterButton = styled.a`
  ...
  &:hover {
    color: ${(props) => props.theme.text.onPrimary};
    background-image: ${(props) =>
      `linear-gradient(to bottom, ${tint(props.theme.social.twitter, 4)}, ${tint(props.theme.social.twitter, 4)})`};
    box-shadow: ${(props) =>
      props.disabled ? 'none' : props.theme.shadows.button};
  }
  ...
  &:focus {
    box-shadow:
      0 0 0 1px ${(props) => props.theme.bg.secondary},
      0 0 0 3px ${(props) => hexa(props.theme.social.twitter, 0.16)};
  }
`;
