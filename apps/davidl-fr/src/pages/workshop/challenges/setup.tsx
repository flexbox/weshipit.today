...
const SETUP_SOURCE_RAW =
  'https://raw.githubusercontent.com/flexbox/react-native-bootcamp/main/setup/README.md';

export default function SetupPage({ source }: MDXProps): ReactElement {
  useEffect(() => {
    Prism.highlightAll();
  }, []);
...
export async function getStaticProps() {
  ...
  const rawContent = await fetch(SETUP_SOURCE_RAW);
